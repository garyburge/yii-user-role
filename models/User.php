...
class User extends CActiveRecord
{
  ...
  public function relations()
  {
    ...
    if (!isset($relations['assignment'])) {
      $relations['assignment'] = array(self::HAS_ONE, 'AuthAssignment', 'user_id');
    }
    if (!isset($relations['roles'])) {
      $relations['roles'] = array(self::HAS_MANY, 'Role', 'user_id', 'through'=>'AuthAssignment');
    }
    return $relations;
  }
